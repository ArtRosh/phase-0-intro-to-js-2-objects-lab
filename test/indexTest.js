...
describe('employees', function() {
  let employee; // Объявляем переменную `employee`

  // Это блок, который будет выполняться перед каждым тестом
  beforeEach(function() {
    employee = { name: 'Sam' }; // Инициализация начального состояния объекта `employee`
  });
